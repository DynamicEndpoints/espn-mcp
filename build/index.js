...
import { formatNews, formatScore, formatTeam, formatRanking, formatPlayerProps, formatPlayerStats, formatStandings } from './formatters.js';
import { exportToMarkdown, createMarkdownTitle } from './markdown.js';
class EspnServer {
    constructor() {
    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                // Export to markdown and get the file path
