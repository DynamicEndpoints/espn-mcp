...
async function handleToolCall(params, espnClient) {
...
async function handleResourceRead(params, espnClient) {
    const { uri } = params;
    try {
        let contents;
        switch (uri) {
...
async function handlePromptGet(params, espnClient) {
    const { name, arguments: args } = params;
 ...
 */
export default function createESPNMCPServer({ config } = {}) {
